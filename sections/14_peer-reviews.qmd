# Peer-Reviews
Here I present the comments I received from the peer-reviewers and the editor of Cambridge Archaeological Journal, as well as my responses to many of the points raised during review.
...
as reviewers note, the landscape of archaeological knowledge formation is quite differentiated, there has been a lot of work on archaeological reflexivity and how these impact methods, and it is really too simple to characterize the whole field as displaying an opposition between objective knowledge/ digital workflows and subjective knowledge/ personal knowledge.
...
> This work explicitly builds upon Dallas' 2015 paper, which was largely theoretical, and which called for more empirical research exploring the social and technological structures that scaffold archaeological data work.
...
> I amended the rest of the paper to reflect these changes.
...
If Activity Theory is used in this particular analysis, it would be reasonable to be explicit about it.
...
> The reviewer is making unwarranted assumptions about the projects that constitute the cases.
...
> I significantly re-worked this section to draw attention to the value that these frameworks bring to bear on my research, and how they complement each other and collectively contributes to the study's overall objective.
> I also brought more information about the methodological approach up from the supplement, and edited this text for enhanced clarity.
...
A number of these consider 'knowledge production' as situated, and look to the power dynamics by which data is recognied and through which 'knowledge' is legitimised.
...
Data is dynamic, and might be considered with relation to 'creative agency'.
...
> The projects that constitute the cases (there were two, not only one --- which implies that the reviewer misread the work) actually comprised archaeologists exhibiting varying levels of experiences and coming from diverse professional backgrounds.
> For instance, neither project was a field school, but both did rely on undergraduate and graduate students' labour; as such they both involved some degree of training.
...
> This being said, the focus of the study was on the projects and the structures that scaffold the work, rather than the individual archaeologists themselves.
> Since the cases constituted academic projects, that was the extent of what I was able to report on.
...
> I never articulated a distinction between digital and analog processes because it was not my intent to draw such a distinction in the first place.
...
## Third Submission (PCI)
**Submitted:** 2025-03-20\
**Reviews Received:** 2025-06-19\
**Revisions Submitted:** 2025-07-xx\
**Decision:** 2025-07-XX

The reviewers' comments and recommender's decision are openly accessible at the Peer Community In Archaeology website: [archaeo.peercommunityin.org/articles/rec?id=608](https://archaeo.peercommunityin.org/articles/rec?id=608).

<!-- ### Editorial Comments
Despite its interest and the high quality of its content and demonstration, this document would merit some modifications on the following points:

- A better balance between the summary and the empirical/analytical aspects (for example, a shorter introductory section would be preferable).
- Clarification of the target audience: who can benefit? archaeologists? specialists in science and technology studies who have no particular knowledge of archaeology?

### Reviewer 1
My main suggestions regard two points:

1. The intended audience of the paper, and
2. he balance between abstract and empirical/analytical aspects

#### Intended audience
In the introduction, the intended audience of this study should be clarified. Who might benefit 
from it?

- Archaeologists? (how and why? given that some detailed descriptions might appear as obvious to archaeologists)
- STS specialists with no particular knowledge about archaeology? (how and why? considering that this manuscript is submitted to an archaeology publishing space, i.e. PCI-archaeo)

Clarifying this point would help, I hope, highlighting the specific contributions of this paper to the understanding of archaeological research processes.
Consequently, I suggest the abstract should be revised to make this specific points more clear.

#### Balance
The paper is divided into the following sections:

- Introduction (including material and methods): 41,000 characters
- Observation: 35,000 characters
- Discussion: 5600 characters
- References and supp. material: 69,000 characters

An unbalance between the different parts of the paper clearly appears here: the introductory section is longer than the sections where empirical data are actually examined and analysed.
In other words, the paper presents a very detailed account about what should be done (providing numerous references to previous work in various fields, STS and archaeology in particular), how it should be done and has been done (cf. the "Methods and Materials" sub-section) which are carefully crafted.
However, when it comes to get something from the carefully collected data (or "capta" as stated), the paper offers much less and might disappoint the readership.
The three sub-sections gathered in the "Observations" section present interesting observations but, given the ambitious "theoretical" introduction and research objectives, we might expect... more... from this section (and from the subsequent "Discussion" section as well).

The material collected during field observation is obviously rich (including the non-reported material (video recording, notes, etc.)) and the material included in this paper (interviews quotes); however, it appears as under-exploited in the paper as it is, and that might potentially be considered as frustrating and a pity by some readers.
Consequently, I suggest the author to:

- Lighten the introductory sections, and the "Approach" sub-section in particular: many literature references from other fields are cited, but without detailed account about how it will be used or applied to this particular study.
- Expand the "Observations" sections, get more benefit from the collected material.
...
##### Observation
p. 11 > Capturing visual media

This section interestingly reveals sociotechnical changes and tensions.
Its contents might be more highlighted, for example by reflecting the main argument get from the comparison between photography and photogrammetry in the title (instead of a simple and purely thematic title "Capturing visual media").

##### Suggested references
The author might be interested in considering the following references (in particular those previous work having investigating archaeological field practices in a similar perspective; see 
Torterat 2020, in particular, about the use of video recording):
...
- Goodwin, Charles. "Practices of Seeing Visual Analysis: an Ethnomethodological Approach." In The Handbook of Visual Analysis, edited by Van Leeuwen, Theo, and Carey Jewitt, 157-82. London: SAGE Publications Ltd, 2004. <https://doi.org/10.4135/9780857020062.n8>.
  - I opted to included alternative references to papers by the same author, which are more directly pertinent to the study of archaeological practice.
- Rousseleau, Raphaël. 2015. "Lire La Terre, Truelle En Main. Une Ethnographie de La Fouille Archéologique Amateure." Ethnographiques. Org 31. <https://www.ethnographiques.org/2015/Rousseleau>.
- Torterat, Gwendoline. 2020. "Être Attentif En Archéologie: Modalités de Transmission d'un « savoir Voir » Entre Experts et Novices Sur Un Site Paléolithique." Revue d'anthropologie Des Connaissances 14 (3). <https://doi.org/10.4000/rac.10867>.

### Reviewer 2
I think the manuscript's main strength lies in its ethnographic depth and conceptual clarity. That said, a few areas would benefit from attention:

The manuscript is very lengthy (over 18,000 words), and some sections (particularly the Background and early Methodological discussions) introduce conceptual terms that are not consistently re-integrated in the Observations and Discussion.
A modest reduction in conceptual redundancy, or a stronger through-line for certain key terms (e.g., "data as capta," "collaborative commitments," "discursive media," "value regimes," and "social worlds") would improve readability and strengthen coherence.
Clarifying which of these are central analytic tools and ensuring they are revisited in the empirical analysis would help maintain conceptual focus throughout.

Related to this, terms like creative agency and collaborative commitment are central but could benefit from slightly more precise or operational definitions early in the paper.
While their meaning becomes clearer through use, more concise framing in the Introduction would help guide readers unfamiliar with the conceptual background.

In line with my observation above, the analysis occasionally risks presenting a binary between constrained fieldworkers and authoritative managers or system designers.
But there are moments where the text gestures toward more nuanced interpretations (e.g., the reflexivity of photogrammetric experts like Rufus), and expanding on these cases would further strengthen the discussion by highlighting variation in how agency is exercised across roles and contexts.

One last small thing: the paper explicitly excludes commercial and community-led archaeology from its scope, and this is acknowledged (p. 6).
While this is reasonable, a short paragraph in the Discussion reflecting on how the findings might (or might not) apply to these other sectors would broaden the relevance of the work without overextending its claims. -->

### Author's response
I am very grateful to the reviewers and to the recommender for their insightful feedback, which contributed to significantly improving the paper.
Here I describe the changes and rationale for my revisions based on their constructive comments.

Dr. Plutniak suggested that I revise the introduction and abstract to clarify the intended audience.
I updated these sections to more explicitly articulate the paper's intended audience and value.
I did not refer to the reasons why this work is not intended for an STS audience because it would require much more explanation than is reasonable to include in an abstract or introduction, which would have distracted from the work itself.
But for the sake of transparency the reasons are that (a) the paper emphasizes specific aspects of archaeological work, rather than outlining a comprehensive theory concerning the instrumentalization of labour, and (b) most archaeologists do not read STS journals and so the practical impact will be relatively limited.

Both reviewers highlighted an imbalance in the text, which prior to the revisions placed significant emphasis on introductory materials, including background and methods.
I agree with both reviewers' suggestion to reduce the size of the methods section, and I trimmed much of the content from the Approach and Data Collection subsections specifically.
Moreover, Dr. Taylor highlighted how the imbalance is reflected in (a) the lack of concrete definitions for key concepts earlier in the paper, and (b) the lack of follow-through on key concepts in later sections.
I therefore more explicitly defined key theoretical concepts like "creative agency" and "collaborative commitments" earlier in the paper (pages 1-2) and drew them into additional interpretive statements throughout the Observations section (pages 10, 14).
In my opinion (and I hope you agree), these changes re-balance the paper and help provide a better "payoff" in the end.

In response to Dr. Taylor's comment regarding a false dichotomy between managers and fieldworkers, this was never my intent, however I could see how the paper could be interpreted in this way.
I therefore revised the discussion to make it more clear that my findings are intended to highlight systemic issues, which restrict behaviours of all parties.
Moreover, I clarify my position that the identities of managers and fieldworkers are not fixed, but are instead associated with the contexts in which they are situated (i.e., that the same person can take on the role of a fieldworker when they enter the trench, and a manager when they are made to design abstract protocols in the dig house).
These revisions further contribute to re-balancing the paper in a way that affords a more satisfying conclusion.

I added a line to the discussion section relating this work to findings made by others in contexts of commercial archaeology --- as suggested by Dr. Taylor (page 18), and included the additional references suggested by Dr. Plutniak (pages 5, 7).
I also revised the titles of the Observations subsections to more precisely account for what each section actually does, in response to Dr. Plutniak's suggestion.

Additionally, I corrected the few typographic errors that were pointed out in the peer-review, as well as additional errors that I spotted on my own.
