...
- STS specialists with no particular knowledge about archaeology? (how and why? considering that this manuscript is submitted to an archaeology publishing space, i.e. PCI-archeo)
...
> Corrected these typographic errors.
...
### Author's response
Thank you to xxxx.
I appreciate the constructive comments and I have revised the manuscript accordingly.
Here I describe the changes and rationale for my revisions.

Both reviewers highlighted the imbalance in the text, which places significant emphasis on introductory materials, including background and methods.
This directly relates to Reviewer 1's concern about the intended audience; I had submitted earlier versions of this manuscript to an archaeological journal, and four anonymous peer-reviewers have requested significant clarification of methodological and background details, which expanded these sections.
I agree with both reviewers' suggestion to reduce the size of the methods section, however rather than removing this text entirely, I relocated most of it to a new section in the supplementary materials.
I think that this decision supports my intention to direct this work to an audience comprising the burgeoning community of archaeologists who develop systematic and critical analysis of archaeological practice and infrastructures, while also making this accessible to archaeologists with less direct experience doing this kind of (qualitative) meta-research.

I took greater care to define key theoretical concepts like "creative agency" and "collaborative commitments" earlier in the text, and to ensure that other key concepts are made relevant in the later discussion.
In my opinion (and I hope you agree), these changes re-balance the paper and help provide a better "payoff" in the end.
Specific changes include:
[Specific references to terms and concepts followed through, revised or removed, including the page numbers where these revisions occur.]{.mark}

In response to Reviewer 2's comment regarding a false dichotomy between managers and fieldworkers, this was never my intent, however I could see how some of the language (especially in the discussion) may present the findings in this way.
I revised the discussion to make it more clear that my findings are intended to highlight systemic issues, which restrict behaviours of all involved parties.
Moreover, I clarify that the identities of managers and fieldworkers are not fixed, but are instead associated with the contexts in which they are situated (i.e., the same person can take on the role of a fieldworker when they enter the trench, and a manager when they are made to design abstract protocols in the dig house).

I added an additional line to the discussion relating this work to findings made by others in contexts of commercial archaeology.
[Specific references needed here.]{.mark}

Thank you to Reviewer 1 for suggesting these additional references.
I included them in the text, specifically on pages XX, YY and ZZ.

In response to Reviewer 1's suggestion, I revised the section title "Capturing visual media" to "xxxx".
I also revised the few typographic errors he pointed out.
