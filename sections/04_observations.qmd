...
Plotting more points makes it easier to draw a more precise line, but experienced illustrators are relatively adept at matching the observed interfaces on the page.<sup>[A13](#sec-A13), [B2](#sec-B2)</sup>
...
In the cases I observed, fieldworkers initially recorded the positions of their finds in relational terms, i.e. as distances in relation to the fixed points from which they measure (see @fig-spatial-relational and @fig-spatial-recording).<sup>[A12](#sec-A12), [B8](#sec-B8)</sup>
When finalizing their paperwork, they sometimes took on the task of calculating fixed positions from the relational distances they initially measured and recorded, but this was not really deemed as an essential task within their purview.<sup>[A15](#sec-A15)</sup>
Instead, this work of converting measured distances into coordinates on the site grid themselves was often delegated to specialists who work with geospatial data.<sup>[B8](#sec-B8)</sup>
...
However this enactment of institutional boundaries did not necessarily reflect fieldworkers' lack of interest in relating their efforts as part of broader geospatial networks<sup>[A17](#sec-A17), [A18](#sec-A18)</sup>
...
They referred to specific boulders by given names, attributed personalities to certain corners, and were able to communicate about specific entities even while using the vaguest of terms (i.e., "that rock," "over there," "behind you").<sup>[A14](#sec-A14), [A16](#sec-A16), [A19](#sec-A19)</sup>
Fieldworkers felt _obliged_ to record formal distances between entities and were bemused by the stock that data managers and analysts put into these formal values.<sup>[A20](#sec-A20)</sup>
